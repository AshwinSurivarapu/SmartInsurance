...
import com.smartinsure.config.jwt.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    @Autowired // Autowire your new JWT filter
    JwtAuthFilter jwtAuthFilter; // Autowire the filter
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // UNCOMMENT AND ADD YOUR JWT FILTER HERE!
